...
ImageFile =  "C:/Users/Sherif/OneDrive/P3/secret.jpg"
StegImageFile = "hidden_secret.jpg"
    ...
    def do_steg(self, steg_text):
        ...
        for ch in range(0, len(steg_text)):
            ...
            for bit in range(0, len(current_char_binary)):
                ...
                current_image_binary = '{0:08b}'.format(ord(self.original_image(map(chr,[self.image_byte_counter]))))
