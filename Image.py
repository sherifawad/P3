...
def _getscaleoffset(expr):
    ...
    try:
        ...
        if (a is stub and b == "__mul__" and isinstance(c, collections.Sequence)):
            return c, 0.0
        if (a is stub and b == "__add__" and isinstance(c, collections.Sequence)):
            return 1.0, c
    except TypeError: pass
    try:
        ((a, b, c), d, e) = data # full syntax
        if (a is stub and b == "__mul__" and isinstance(c, collections.Sequence) and
            d == "__add__" and isinstance(e, collections.Sequence)):
            return c, e
    except TypeError: pass
